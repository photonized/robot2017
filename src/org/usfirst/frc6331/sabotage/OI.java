...
public class OI {
    ...
    public OI() {
        ...
        joystickButton1.whileHeld(new DriveWithJoysticks());
        
        
        double value;
        value = leftJoystick.getX();
        value = leftJoystick.getY();
        value = leftJoystick.getZ();
        value = leftJoystick.getTwist();
        value = leftJoystick.getThrottle();
